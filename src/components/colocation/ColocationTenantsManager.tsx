  ...
  const handleDownloadContract = async () => {
    ...
    try {
      ...
      await generateColocationContractPDF({
        ...
        ownerEmail: contract.property?.owner?.email || undefined,
        ownerPhone: contract.property?.owner?.phone || undefined,
        ownerAddress: contract.property?.owner?.address || undefined,
