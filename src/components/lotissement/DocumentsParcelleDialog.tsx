              ...
              onClick={async () => {
                ...
                try {
                  ...
                  const templateData: AttestationTemplateData | null = attestationTemplate ? {
                    ...
                    header_ministere: (attestationTemplate as any).header_ministere || null,
                    header_region: (attestationTemplate as any).header_region || null,
                    header_departement: (attestationTemplate as any).header_departement || null,
                    header_republique: (attestationTemplate as any).header_republique || null,
                    header_devise: (attestationTemplate as any).header_devise || null,
                    ...
                    right_logo_url: (attestationTemplate as any).right_logo_url || null,
                    header_line_color: (attestationTemplate as any).header_line_color || null,
                    title_border_color: (attestationTemplate as any).title_border_color || null,
                    title_bg_color: (attestationTemplate as any).title_bg_color || null,
                    ...
                    watermark_position_x: (attestationTemplate as any).watermark_position_x ?? null,
                    watermark_position_y: (attestationTemplate as any).watermark_position_y ?? null,
                    watermark_rotation: (attestationTemplate as any).watermark_rotation ?? null,
