  ...
  const handleGenerateAttestation = async (parcelle: Parcelle) => {
    ...
    try {
      ...
      const templateData: AttestationTemplateData | null = tpl ? {
        ...
        commune: tpl.commune,
        village: tpl.village,
        header_ministere: (tpl as any).header_ministere || null,
        header_region: (tpl as any).header_region || null,
        header_departement: (tpl as any).header_departement || null,
        header_republique: (tpl as any).header_republique || null,
        header_devise: (tpl as any).header_devise || null,
        ...
        watermark_position_x: (tpl as any).watermark_position_x ?? null,
        watermark_position_y: (tpl as any).watermark_position_y ?? null,
        watermark_rotation: (tpl as any).watermark_rotation ?? null,
        ...
        {canDelete && someSelected && (
          <div className="p-3 border-b bg-destructive/5 flex items-center gap-3">
            ...
            >
              ...
              {isBulkDeleteLoading ? "Suppression..." : "Supprimer la sélection"}
            </Button>
