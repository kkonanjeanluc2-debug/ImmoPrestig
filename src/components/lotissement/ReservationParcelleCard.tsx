...
import { Calendar, User, Banknote, Clock, X, ShoppingCart } from "lucide-react";
...
export function ReservationParcelleCard({ reservation, parcelle }: ReservationParcelleCardProps) {
          ...
          <div className="flex gap-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="outline" size="sm" className={`text-destructive hover:text-destructive ${parcelle ? "" : "w-full"}`}>
