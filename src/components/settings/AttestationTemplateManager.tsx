...
const SAMPLE_DATA: Record<string, string> = {
  ...
  "{header_ministere}": "Ministère de la Construction",
  "{header_region}": "Région des Lagunes",
  "{header_departement}": "Département d'Abidjan",
  "{header_republique}": "République de Côte d'Ivoire",
  "{header_devise}": "Union-Discipline-Travail",
  "{ministere}": "Ministère de la Construction",
