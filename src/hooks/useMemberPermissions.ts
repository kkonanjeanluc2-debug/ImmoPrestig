...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  can_edit_payments: "Encaisser loyer",
  can_delete_payments: "Relance",
...
export const DEFAULT_PERMISSIONS: Record<string, Partial<MemberPermissions>> = {
  admin: {
    ...
    can_access_achat_contracts_tab: true,
  ...
  gestionnaire: {
    ...
    can_access_achat_contracts_tab: false,
  ...
  // STRICT comptable: full read on financial data, can create invoices/expenses/payouts
  // and edit payments, but NO destructive action on entities (no delete, no contract edit).
  comptable: {
    can_view_properties: true,
    can_create_properties: false,
    can_edit_properties: false,
