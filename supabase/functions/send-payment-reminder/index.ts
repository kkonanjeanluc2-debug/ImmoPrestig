  ...
  try {
    ...
    if (!tenantEmail) {
      return new Response(
        JSON.stringify({
          success: false,
          error: "Email du locataire non disponible",
        }),
        {
    ...
    const emailResponse = await resend.emails.send({
      ...
      html: `
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>${headerIcon} Rappel de paiement</h1>
            </div>
            <div class="content">
              ...
              <div style="background: white; padding: 15px; border-radius: 8px;">
                ...
                <div class="info-row" style="border: none;">
                  ...
                  <span class="value">${formattedAmount} F CFA</span>
                </div>
              </div>
    ...
    return new Response(
      JSON.stringify({
        success: true,
        message: `Rappel envoyé à ${tenantEmail}`,
      }),
      {
        headers: { ...corsHeaders, "Content-Type": "application/json" },
        status: 200,
