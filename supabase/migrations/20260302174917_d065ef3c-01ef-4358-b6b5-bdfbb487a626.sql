...
AS $function$
  SELECT 
    -- User is the property owner (creator)
    ...
    OR
    -- User is agency owner and property was created by a member of this agency (active or not)
    EXISTS (
      SELECT 1 FROM public.agencies a
      JOIN public.agency_members am ON am.agency_id = a.id
    ...
    OR
    -- User is active admin member and property creator belongs/belonged to same agency
    EXISTS (
      SELECT 1
